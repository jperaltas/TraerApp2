    ...
    public boolean send() throws Exception {
        ...
        if(!_user.equals("") && !_pass.equals("") && _to.length() > 0 && !_from.equals("") && !_subject.equals("") && !_body.equals("")) {
            ...
            */
            ...
            try
            {
                Log.d("Correo","Entro al Try");
                Log.d("Correo", _user+" "+_pass+" "+_from+" "+_subject);
                ...
                address[0] = new InternetAddress(_to);


                message.setRecipients(MimeMessage.RecipientType.TO, address);

                // Con Copia a :
                InternetAddress[] address_cc = new InternetAddress[1];
                address_cc[0] = new InternetAddress(_to);
                message.setRecipients(MimeMessage.RecipientType.CC, address_cc);
            ...
            {
                System.out.println("No se envio reporte");
                return false;
            }
