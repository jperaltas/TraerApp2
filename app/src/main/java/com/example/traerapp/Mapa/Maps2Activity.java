...
public class Maps2Activity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datpref.setCoordenadasLlegada(getApplicationContext(),markerCenter.getPosition().toString(),markerCenter.getPosition().longitude,markerCenter.getPosition().latitude);
                Intent intent1 = new Intent (getApplicationContext(), Pago.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        markerCenter = mMap.addMarker(new MarkerOptions().position(sydney).title("Dejarme Aquí").draggable(true));
